...
// ~~ AC130 Remastered ~~
// Cleaned up script and added the customizable dvars
// By H3X1C
//
// -- AC130 Settings --
...
init()
{
	...
	setDvarIfUninitialized( "scr_ac130_duration", 20 );				// Time(s) ac130 lasts (Default 20)
	setDvarIfUninitialized(  "scr_ac130_flares", 2 );				// Number of flares it has prevents ac130 getting shot down (Default 2)
