...
// Nuke added to the whitelist to prevent kills counting towards streak after player has died
// Cleaned up code and removed uneeded comments
//
...
resetPlayerVariables()
{
	...
	// Want them detached before we create our corpse
...
// Claims the use trigger for player and displays a use bar, Returns true if the player sucessfully fills the use bar
useHoldThink( player )
{
