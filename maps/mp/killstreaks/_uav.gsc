...
// ~~ UAV Remastered ~~
// Re-added the missing kill feed messages and timeout server setting
// By H3X1C with special thanks to Emosewaj
//
// -- UAV Settings --
// scr_uav_timeout 				- UAV timer in seconds (default=30)
// scr_counter_uav_timeout		- Counter UAV in seconds (default=30)
//
