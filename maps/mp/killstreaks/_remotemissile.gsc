...
// ~~ Predator Remastered ~~
// Added earthquake rumble
// By H3X1C with special thanks to Emosewaj
//
// -- Predator settings --
// *Predator earthquake magnitude (How strong the earthquake effect is) (default=0.6)
// scr_predator_earthquake_magnitude = 0.6		- Standard earthquake
// scr_predator_earthquake_magnitude = 0		- Disbled earthquake
//
// *Predator earthquake radius (The radius in which the earthquake is present) (default=5000)
// scr_predator_earthquake_radius = 5000		- Standard earthquake
// scr_predator_earthquake_radius = 0			- Disbled earthquake
//
// *Predator earthquake duration (how long the earthquake effect lasts) (default=2)
// scr_predator_earthquake_duration = 2			- Standard earthquake duration
...
init()
{
	...
	setDvarIfUninitialized( "scr_predator_earthquake_magnitude", 0.6 );
	setDvarIfUninitialized( "scr_predator_earthquake_radius", 5000 );
	setDvarIfUninitialized( "scr_predator_earthquake_duration", 2 );

	level.predatorEarthquakeMagnitude = getDvarFloat( "scr_predator_earthquake_magnitude" );
	level.predatorEarthquakeRadius = getDvarFloat( "scr_predator_earthquake_radius" );
	level.predatorEarthquakeDuration = getDvarFloat( "scr_predator_earthquake_duration" );
}
...
MissileEyes( player, rocket )
{
	...
	if ( isDefined( rocket ) )
	{
		...
		// Earthquake added for effect
		if ( level.predatorEarthquakeMagnitude != 0 || level.predatorEarthquakeDuration != 0 || level.predatorEarthquakeRadius != 0 )
			earthquake( level.predatorEarthquakeMagnitude, level.predatorEarthquakeDuration, rocket.origin, level.predatorEarthquakeRadius );
