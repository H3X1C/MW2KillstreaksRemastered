...
//
// -- AC130 Settings --
// scr_ac130_duration 		- AC130 duration in seconds (default=40)
...
setAC130Player( player )
{
	...
	player thread removeAC130PlayerAfterTime( level.ac130_use_duration + 3);	//Accounts for menu file issue
